    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 0" class="badge success">已完�?/span>
            <span v-else-if="currentPhase === 0" class="badge processing">生成�?/span>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 1" class="badge success">已完�?/span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            基于生成的本体，将文档自动分块后调用 Zep 构建知识图谱，提取实体和关系，并形成时序记忆与社区摘�?          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">图谱构建已完成，请进入下一步进行模拟环境搭�?/p>
          <button 
            class="action-btn" 
...
// 进入环境搭建 - 创建 simulation 并跳�?const handleEnterEnvSetup = async () => {
  if (!props.projectData?.project_id || !props.projectData?.graph_id) {
    console.error('缺少项目或图谱信�?)
    return
  }
