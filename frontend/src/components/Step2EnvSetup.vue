    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">回溯实例初始化</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">已完�?/span>
            <span v-else class="badge processing">初始�?/span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationId" class="info-card">
            ...
            <div class="info-row">
              ...
              <span class="info-value mono">{{ taskId || '异步任务已完�? }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 1" class="badge success">已完�?/span>
        ...
        <div class="card-content">
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">现实种子当前关联话题�?/span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            ...
            <div class="profiles-list">
              ...
              >
                ...
                <p class="profile-bio">{{ profile.bio || '暂无简�? }}</p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">生成双平台模拟配�?/span>
          </div>
          <div class="step-status">
            <span v-if="phase > 2" class="badge success">已完�?/span>
            <span v-else-if="phase === 2" class="badge processing">生成�?/span>
            <span v-else class="badge pending">等待</span>
          </div>
        </div>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">总轮�?/span>
                ...
                <div class="config-item">
                  <span class="config-item-label">每小时活�?/span>
              ...
              <div class="agents-cards">
                ...
                >
                  ...
                  <div class="agent-params">
                    ...
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">活跃�?/span>
                      ...
                      <div class="param-item">
                        <span class="param-label">影响�?/span>
              ...
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">平台 1：广�?/ 信息�?/span>
                  </div>
                  <div class="platform-params">
                    ...
                    <div class="param-row">
                      <span class="param-label">相关性权�?/span>
                      <span class="param-value">{{ simulationConfig.twitter_config.relevance_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">病毒阈�?/span>
                      <span class="param-value">{{ simulationConfig.twitter_config.viral_threshold }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">回音室强�?/span>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name">平台 2：话�?/ 社区</span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">时效权重</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">初始激活编�?/span>
          </div>
          <div class="step-status">
            <span v-if="phase > 3" class="badge success">已完�?/span>
            <span v-else-if="phase === 3" class="badge processing">编排�?/span>
            <span v-else class="badge pending">等待</span>
          </div>
        </div>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            基于叙事方向，自动生成初始激活事件与热点话题，引导模拟世界的初始状�?          </p>
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="initial-posts-section">
              <span class="box-label">初始激活序�?({{ simulationConfig.event_config.initial_posts.length }})</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase >= 4" class="badge processing">进行�?/span>
            <span v-else class="badge pending">等待</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <p class="description">模拟环境已准备完成，可以开始运行模�?/p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish 自动规划推演现实 <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> 小时，每轮代表现�?<span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> 分钟时间流�?/span>
              </div>
              <label class="switch-control">
                <input type="checkbox" v-model="useCustomRounds">
                <span class="switch-track"></span>
                <span class="switch-label">自定�?/span>
              </label>
            </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>若Agent规模�?00：预计耗时�?{{ Math.round(customMaxRounds * 0.6) }} 分钟</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        若Agent规模�?00：预计耗时 {{ Math.round(autoGeneratedRounds * 0.6) }} 分钟
                      </span>
                    </div>
                    <div class="auto-desc">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            ...
            <div class="info-item">
              ...
              <span class="info-value">{{ { male: '�?, female: '�?, other: '其他' }[selectedProfile.gender] || selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
          ...
          <div class="modal-section">
            <span class="section-label">人设简�?/span>
            <p class="section-bio">{{ selectedProfile.bio || '暂无简�? }}</p>
          </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">经验总结与行事风格偏�?/span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">独特记忆印记</span>
                <span class="dim-desc">基于现实种子形成的记�?/span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">社会关系网络</span>
                <span class="dim-desc">个体链接与交互图�?/span>
              </div>
            </div>
...
// State
const phase = ref(0) // 0: 初始�? 1: 生成人设, 2: 生成配置, 3: 完成
...
const customMaxRounds = ref(40)   // 默认推荐40�?
...
watch(currentStage, (newStage) => {
  if (newStage === '生成Agent人设' || newStage === 'generating_profiles') {
    ...
    phase.value = 2
    // 进入配置生成阶段，开始轮询配�?    if (!configTimer) {
      addLog('开始生成双平台模拟配置...')
      startConfigPolling()
    }
  } else if (newStage === '准备模拟脚本' || newStage === 'copying_scripts') {
    phase.value = 2 // 仍属于配置阶�?  }
})
...
// 处理开始模拟按钮点�?const handleStartSimulation = () => {
  // 构建传递给父组件的参数
  const params = {}
  
  if (useCustomRounds.value) {
    // 用户自定义轮数，传�?max_rounds 参数
    params.maxRounds = customMaxRounds.value
    addLog(`开始模拟，自定义轮�? ${customMaxRounds.value} 轮`)
  } else {
    // 用户选择保持自动生成的轮数，不传�?max_rounds 参数
...
// 自动开始准备模�?const startPrepareSimulation = async () => {
  if (!props.simulationId) {
    addLog('错误：缺�?simulationId')
  ...
  // 标记第一步完成，开始第二步
  phase.value = 1
  addLog(`模拟实例已创�? ${props.simulationId}`)
  addLog('正在准备模拟环境...')
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (res.data.expected_entities_count) {
        ...
        addLog(`从Zep图谱读取�?${res.data.expected_entities_count} 个实体`)
...
const pollPrepareStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // 解析阶段信息并输出详细日�?      if (data.progress_detail) {
      ...
      // 检查是否完�?      if (data.status === 'completed' || data.status === 'ready' || data.already_prepared) {
        addLog('�?准备工作已完�?)
        stopPolling()
        stopProfilesPolling()
        await loadPreparedData()
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // 只有�?API 返回有效值时才更新，避免覆盖已有的有效�?      if (res.data.total_expected) {
      ...
      // 输出 Profile 生成进度日志（仅当数量变化时�?      const currentCount = profiles.value.length
...
const fetchConfigRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // 如果配置已生�?      if (data.config_generated && data.config) {
        ...
        if (data.config.time_config) {
          ...
          addLog(`时间配置: 每轮${tc.minutes_per_round}分钟, �?{Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)}轮`)
        }
...
const loadPreparedData = async () => {
  ...
  addLog(`已加�?${profiles.value.length} 个Agent人设`)
